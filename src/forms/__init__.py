...
class DogSearch(Form):
    ...
    sort = SelectField(Markup(u"сортировать по"), choices = [(1, Markup(u"дороже")), (2, Markup(u"дешевле")), (3, u"дате"), (4, u"привлекательности")], coerce = int)
...
class SaleSearch(Form):
    ...
    perpage = SelectField(u"Объявлений на стр.", default = 15,
    coerce=int,choices = [(1, 10), (2, 20), (3, 30), (4, 50), (5, 100)])
